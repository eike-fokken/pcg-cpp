    ...
    std::false_type)
{
    ...
    constexpr std::size_t SRC_SIZE  {sizeof(src_t)};
    constexpr std::size_t SRC_BITS  {SRC_SIZE * 8};
    constexpr std::size_t DEST_SIZE {sizeof(dest_t)};
    constexpr std::size_t SCALE     {(DEST_SIZE+SRC_SIZE-1) / SRC_SIZE};
